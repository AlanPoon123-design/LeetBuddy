...
DO NOT GIVE THE ANSWER IF THE PROMPT DOES NOT REQUEST IT. Be brief with your response. Give your response in the same language as the user's question.`;
...
Explain your reasoning briefly before providing the final answer or code example. If the context is unclear, incomplete, or contains conflicting information, state that clearly.
Be brief with your response. Give your response in the same language as the user's question.`;
